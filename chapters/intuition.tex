...
Demodularization of the program proceeds by following the \racket{require} graph and including all phase 0 code from the required modules into the main module of the program. 
