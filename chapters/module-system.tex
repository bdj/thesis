...
The \racket{require} form has three parts in this module that all show different features of the module system.
...
After that, the module has a call to the \racket{set-val!} function from the \texttt{obj} module at runtime.
