...
It also shows whether or not a module is required with \racket{for-syntax}, which determines what phase the module is available at in relation to the rest of the program.
